// Transform data from a given shape (serverResponse) to another (uiInput).

// There are 3 ID spaces -- a “chemical id”, “item source data” (isd), and upc.  ISDs and chemical IDs have a one-to-one
// mapping.  UPCs are the ids for the actual packages, and map to ISDs.  There are multiple UPCs per ISD.
